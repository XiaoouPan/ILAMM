...
#' fit$beta
#' @export
ncvxHuberReg <- function(X, Y, lambda = -1, penalty = "SCAD", tau = -1, phi0 = 0.001, gamma = 1.5, epsilon_c = 0.001, epsilon_t = 0.001, iteMax = 500L, intercept = FALSE, itcpIncluded = FALSE) {
...
#' fit$tauMin
#' @export
cvNcvxHuberReg <- function(X, Y, lSeq = NULL, nlambda = 30L, penalty = "SCAD", tSeq = NULL, ntau = 5L, phi0 = 0.001, gamma = 1.5, epsilon_c = 0.001, epsilon_t = 0.001, iteMax = 500L, nfolds = 3L, intercept = FALSE, itcpIncluded = FALSE) {
...
#' fit$tau
#' @export
tfNcvxHuberReg <- function(X, Y, lSeq = NULL, nlambda = 30L, penalty = "SCAD", phi0 = 0.001, gamma = 1.5, epsilon_c = 0.001, epsilon_t = 0.001, iteMax = 500L, nfolds = 3L, intercept = FALSE, itcpIncluded = FALSE, tfConst = 2.5) {
    .Call('_ILAMM_tfNcvxHuberReg', PACKAGE = 'ILAMM', X, Y, lSeq, nlambda, penalty, phi0, gamma, epsilon_c, epsilon_t, iteMax, nfolds, intercept, itcpIncluded, tfConst)
}
